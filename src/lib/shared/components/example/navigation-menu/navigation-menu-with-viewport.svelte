<script lang="ts">
	import * as NavigationMenu from '$lib/shared/components/ui/navigation-menu/index.js';
	import { navigationMenuTriggerStyle } from '$lib/shared/components/ui/navigation-menu/navigation-menu-trigger.svelte';
